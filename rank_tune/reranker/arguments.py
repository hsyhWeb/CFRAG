...
class DataArguments:
    train_data: str = field(
        default=
        "../../Meta-Llama-3-8B-Instruct_outputs/LaMP_2_time/train/recency/bge-base-en-v1.5_5/retrieval/point_20241009-122157_user-6_20241009-120906_vllm_new-64/predictions_0-100.json",
